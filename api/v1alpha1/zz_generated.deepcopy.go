...
func (in *ActiveCheckK8sJobsStatus) DeepCopyInto(out *ActiveCheckK8sJobsStatus) {
	*out = *in
	...
	if in.LastK8sJobScheduleTime != nil {
		in, out := &in.LastK8sJobScheduleTime, &out.LastK8sJobScheduleTime
		*out = (*in).DeepCopy()
	}
	if in.LastK8sJobSuccessfulTime != nil {
		in, out := &in.LastK8sJobSuccessfulTime, &out.LastK8sJobSuccessfulTime
		*out = (*in).DeepCopy()
	}
}
