...
func (in *ActiveCheckSpec) DeepCopyInto(out *ActiveCheckSpec) {
	*out = *in
	...
	out.SpecNCCLTests = in.SpecNCCLTests
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SpecNCCLTests) DeepCopyInto(out *SpecNCCLTests) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SpecNCCLTests.
func (in *SpecNCCLTests) DeepCopy() *SpecNCCLTests {
	if in == nil {
		return nil
	}
	out := new(SpecNCCLTests)
	in.DeepCopyInto(out)
	return out
}
