...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GRes) DeepCopyInto(out *GRes) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GRes.
func (in *GRes) DeepCopy() *GRes {
	if in == nil {
		return nil
	}
	out := new(GRes)
