...
kubectl --context="$context_name" --namespace=dstaroff delete -f common/config/ssh_root_keys_secret.yaml
kubectl --context="$context_name" --namespace=dstaroff delete -f common/config/munge_key_secret.yaml
