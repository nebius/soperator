...
# https://github.com/nebius/ml-containers/actions/runs/31962108190
FROM cr.eu-north1.nebius.cloud/ml-containers/slurm:${SLURM_VERSION}-20260816173636 AS controller_slurmctld
