...
FROM cr.nebius.cloud/soperator-proxy-docker-io/library/golang:1.25 AS go-base
...
FROM cr.nebius.cloud/ml-containers/slurm:${SLURM_VERSION}-20260925081218 AS controller_slurmctld
