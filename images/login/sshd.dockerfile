...
FROM cr.eu-north1.nebius.cloud/ml-containers/neubuntu:noble-20260908101311 AS login_pam_builder
...
# https://github.com/nebius/ml-containers/pull/102
FROM cr.eu-north1.nebius.cloud/ml-containers/slurm:${SLURM_VERSION}-20260908103131 AS login_sshd
...
COPY images/login/supervisord.conf /etc/supervisor/soperator-login.conf
...
RUN chmod +x \
        ...
        /opt/bin/slurm/docker_proxy_entrypoint.sh \
        /usr/bin/soperator-docker-proxy
