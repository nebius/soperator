...
# Install OpenSSH server, Docker, and process-supervision dependencies
...
RUN PAM_MODULE_DIR="/usr/lib/$(gcc -print-multiarch)/security" && \
    ...
    rm -rf /usr/src/pam-soperator-jail
