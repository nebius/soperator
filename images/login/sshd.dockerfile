...
FROM cr.nebius.cloud/ml-containers/neubuntu:noble-20260916135615 AS login_pam_builder
...
FROM cr.nebius.cloud/ml-containers/slurm:${SLURM_VERSION}-20260908103131 AS login_sshd
