...
# https://github.com/nebius/ml-containers/pull/46
FROM cr.eu-north1.nebius.cloud/ml-containers/training_diag:${CUDA_VERSION}-ubuntu24.04-20260116120703 AS jail
