Feature: System settings
  ...
  Scenario: Login SSH sessions retain the default resource limits in nested Bash
  ...
  Scenario: Worker SSH sessions expose fully configured resource limits
  ...
  @unstable @soperator_version_>=4.0.0
  Scenario: Native Slurm jobs expose fully configured resource limits
    Given a healthy worker is selected for system-settings checks
  ...
  @unstable @soperator_version_>=4.0.0
  Scenario: Enroot Slurm jobs expose fully configured resource limits
    Given a healthy worker is selected for system-settings checks
