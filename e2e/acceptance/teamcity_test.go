...
`)},
	...
	assert.Contains(t, report, "testStarted name='reporting: features/teamcity.feature: skips'")
	...
	assert.Contains(t, report, "testFinished name='reporting: features/teamcity.feature: skips'")
}
