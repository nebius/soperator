...
HC_OUTPUT=$(srun --cpu-bind=cores bash -l -c "health-checker run -e soperator-acceptance -p $platform -n dcgmi_diag_r3 -f json-partial --tests-stdout-path /opt/soperator-outputs/health_checker_cmd_stdout")
