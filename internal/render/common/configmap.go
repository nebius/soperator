...
func generateSlurmConfig(cluster *values.SlurmCluster) renderutils.ConfigFile {
	...
	if cluster.HasEphemeralNodes() {
		...
		res.AddProperty("SuspendTime", 300)
		res.AddProperty("SuspendTimeout", 60)
		res.AddProperty("ResumeRate", 300)  // default value in the Slurm docs
		res.AddProperty("SuspendRate", 300) // default value in the Slurm docs
