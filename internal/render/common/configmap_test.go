...
func TestBuildNodeSetNodeNamesMap(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expected: map[string]string{
				"test": "worker-test-0,worker-test-1,worker-test-2",
			},
		},
		{
			...
			expected: map[string]string{
				"gpu": "worker-gpu-0,worker-gpu-1",
				"cpu": "worker-cpu-0,worker-cpu-1,worker-cpu-2,worker-cpu-3",
			},
		},
		{
...
func TestAddStructuredPartitions(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expected: "## Structured partitions will be generated by partition config reconciler\nPartitionName=main Nodes=worker-gpu-0,worker-gpu-1 Default=YES State=UP",
		},
		{
			...
			expected: "## Structured partitions will be generated by partition config reconciler\nPartitionName=gpu-partition Nodes=worker-gpu-0,worker-gpu-1 State=UP\nPartitionName=cpu-partition Nodes=worker-cpu-0,worker-cpu-1,worker-cpu-2 State=UP",
		},
		{
			...
			expected: "## Structured partitions will be generated by partition config reconciler\nPartitionName=combined Nodes=worker-gpu-0,worker-cpu-0,worker-cpu-1 State=UP",
		},
		{
			...
			expected: "## Structured partitions will be generated by partition config reconciler\nPartitionName=main Nodes=worker-gpu-0,worker-gpu-1 State=UP\nPartitionName=all-nodes Nodes=worker-gpu-0,worker-gpu-1 Default=YES",
		},
		{
			...
			expected: "## Structured partitions will be generated by partition config reconciler\nPartitionName=simple Nodes=worker-cpu-0",
		},
		{
