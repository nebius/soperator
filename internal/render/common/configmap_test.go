...
func TestRenderConfigMapSlurmConfigs_FileNamesAndWarnings(t *testing.T) {
	...
	assert.Contains(t, result.Data[consts.ConfigMapKeySlurmConfig], "include "+consts.ConfigMapKeyAutogenSlurmConfig)
	assert.Contains(t, result.Data[consts.ConfigMapKeyAutogenSlurmConfig], ManagedSlurmConfigWarning())
	assert.Contains(t, result.Data[consts.ConfigMapKeyAutogenSlurmConfig], "include "+consts.ConfigMapKeyCustomSlurmConfig)
	assert.Contains(t, result.Data[consts.ConfigMapKeyCustomSlurmConfig], "Generated by Soperator from customSlurmConfig")
	assert.Contains(t, result.Data[consts.ConfigMapKeyRESTConfig], "include "+consts.ConfigMapKeySlurmConfig)
