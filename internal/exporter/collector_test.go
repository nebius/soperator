...
func TestMetricsCollector_Collect_Success(t *testing.T) {
	...
	synctest.Run(func() {
		...
		expectedMetrics := []string{
			`GAUGE; slurm_node_info{address="10.0.0.1",instance_id="instance-1",node_name="node-1",reason="",state_base="ALLOCATED",state_is_drain="false",state_is_maintenance="false",state_is_reserved="false"} 1`,
...
func TestMetricsCollector_NodeFails(t *testing.T) {
	...
	synctest.Run(func() {
		...
		expectedNodeMetrics := []string{
			`GAUGE; slurm_node_info{address="10.0.0.3",instance_id="instance-maintenance",node_name="node-maintenance",reason="",state_base="IDLE",state_is_drain="false",state_is_maintenance="true",state_is_reserved="false"} 1`,
			`GAUGE; slurm_node_info{address="10.0.0.4",instance_id="instance-reserved",node_name="node-reserved",reason="",state_base="IDLE",state_is_drain="false",state_is_maintenance="false",state_is_reserved="true"} 1`,
		}
		...
		expectedNodeInfoMetric := `GAUGE; slurm_node_info{address="10.0.0.3",instance_id="instance-maintenance",node_name="node-maintenance",reason="maintenance drain triggered",state_base="IDLE",state_is_drain="true",state_is_maintenance="true",state_is_reserved="false"} 1`
...
func TestMetricsCollector_GetDiag_APIError(t *testing.T) {
	...
	synctest.Run(func() {
		...
		assert.Contains(t, metricsText, `GAUGE; slurm_node_info{address="10.0.0.1",instance_id="test-instance",node_name="test-node",reason="",state_base="IDLE",state_is_drain="false",state_is_maintenance="false",state_is_reserved="false"} 1`)
...
// E.g.:
// GAUGE; slurm_node_info{address="10.0.0.1",instance_id="computeinstance-xyz",node_name="worker-0",reason="",state_base="idle",state_is_drain="false",state_is_maintenance="false",state_is_reserved="false"} 1
