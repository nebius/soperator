...
func (_m *MockClock) Sleep(duration time.Duration) {
	_m.Called(duration)
}
...
func (_e *MockClock_Expecter) Sleep(duration interface{}) *MockClock_Sleep_Call {
	return &MockClock_Sleep_Call{Call: _e.mock.On("Sleep", duration)}
}

func (_c *MockClock_Sleep_Call) Run(run func(duration time.Duration)) *MockClock_Sleep_Call {
	_c.Call.Run(func(args mock.Arguments) {
