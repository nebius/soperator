...
func TestWorkerTopologyReconciler_updateTopologyConfigMap_Fixed(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			err := reconciler.updateTopologyConfigMap(ctx, namespace, consts.ConfigMapNameTopologyConfig, "new-topology-config", "test-cluster", consts.ConfigMapKeyTopologyConfig)
...
func TestWorkerTopologyReconciler_renderTopologyConfigMap(t *testing.T) {
	...
	cm := r.renderTopologyConfigMap(namespace, consts.ConfigMapNameTopologyConfig, config, consts.ConfigMapKeyTopologyConfig)
