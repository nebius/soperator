...
IMG ?= cr.nemax.nebius.cloud/crnsp9v7ps4c2uks5n6a/slurm-operator-controller
TAG ?= latest
...
manifests: controller-gen ## Generate WebhookConfiguration, ClusterRole and CustomResourceDefinition objects.
	$(CONTROLLER_GEN) rbac:roleName=manager-role crd:maxDescLen=0 webhook paths=$(GENPATH) output:crd:artifacts:config=config/crd/bases
...
.PHONY: bazel-run
run: manifests generate fmt  ## Run a controller from your host with bazel.
